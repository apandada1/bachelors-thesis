...
However, the net magnetization density is slightly different from the sum of the individual orbital magnetic moments. This is because, the phase space density changes when as we turn on a magnetic field (even in the limit of a zero magnetic field, see the expression of $\vec{M}$ below).
...
$$
\begin{aligned}
\vec{M} &= \left.\frac{\partial G}{\partial \vec{B}}\right|_{\vec{B}=0} \\
